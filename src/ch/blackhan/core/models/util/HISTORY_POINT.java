...
public class HISTORY_POINT implements Cloneable {
    ...
    private double openBid, openAsk;
    private double closeBid, closeAsk;
    private double minBid, maxBid;
    private double minAsk, maxAsk;
    private boolean corrected = false; //@TODO: Meaning?
